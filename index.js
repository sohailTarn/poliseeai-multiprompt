...
app.post('/answer-question', async (req, res) => {
  try {
    ...
    Both documents will be from Financial Institutions. The first document will be from the source bank and the second document will be from a target bank who is a client of yours. Make sure you know that UAR and SAR different if you find them in the documents.
